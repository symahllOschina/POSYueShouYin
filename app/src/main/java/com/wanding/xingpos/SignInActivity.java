    ...
    private void loginJsonStr(String jsonStr){
        ...
        if(Utils.isNotEmpty(jsonStr)){
            try {
                ...
                messageStr = job.getString("message");
                if("200".equals(statusStr)){
                    Log.e("签到查询状态：", "成功！");
                    loginInfoStr = job.getString("data");
//                    ToastUtil.showText(activity,"签到成功！",1);
                }else{
                    if(Utils.isNotEmpty(messageStr)){

                        ToastUtil.showText(activity,messageStr,Toast.LENGTH_LONG,2);
...
//                logResData.setEid("132");
                ...
                logResData.setEaccount(dataJob.getString("eaccount"));
                logResData.setStoreName(dataJob.getString("storeName"));
            ...
            logResData.setEid("");
            logResData.setEname("");
            logResData.setEaccount("");
            logResData.setStoreName("");
        ...
        if(!isPrint){
            ...
            intent.putExtra("userLoginData",logResData);
